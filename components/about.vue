     ...
     <div class="container">
         <div class="row">
             <div class="section-title">
                 <h1>Our Team</h1>
                 <p>We are a talented team of Computer Science students from the University of Bristol who want to bring out the best of technology in sustainable development.</p>
             </div>
         </div>
         <div class="row">
             <div class="team-items">
                  ...
                  <div class="item">
                      <img src="2.jpg" alt="team" />
                      <div class="inner">
                          <div class="info">
                               <h5>Karthik Sridhar</h5>
                               <p>Co-Founder, COO</p>
                               <div class="social-links">
                                   <a href=""><span class="fa fa-facebook"></span></a>
                                   <a href=""><span class="fa fa-twitter"></span></a>
                  ...
                  <div class="item">
                      <img src="3.jpg" alt="team" />
                      <div class="inner">
                          <div class="info">
                               <h5>Tharidu Jayaratne</h5>
                               <p>Lead Programmer</p>
                               <div class="social-links">
                                   <a href=""><span class="fa fa-facebook"></span></a>
                                   <a href=""><span class="fa fa-twitter"></span></a>
